...
export const createCodingProject = async (
  input: CreateCodingProjectInput,
...
export const updateCodingProject = async (
  projectId: string,
  input: UpdateCodingProjectInput,
): Promise<void> => {
...
export const createGamingProject = async (
  input: CreateGamingProjectInput,
...
export const updateGamingProject = async (
  gameId: string,
  input: UpdateGamingProjectInput,
): Promise<void> => {
...
export const getActivities = async (constraints: QueryConstraint[] = []): Promise<Activity[]> => {
  ...
  const baseConstraints = [where('userId', '==', userId), orderBy('startTime', 'desc')]

  const q = query(collection(db, COLLECTIONS.ACTIVITIES), ...baseConstraints, ...constraints)
