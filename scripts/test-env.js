...
console.log('FIREBASE_STORAGE_BUCKET:', process.env.FIREBASE_STORAGE_BUCKET ? '✅ Loaded' : '❌ Missing');
console.log('FIREBASE_MESSAGING_SENDER_ID:', process.env.FIREBASE_MESSAGING_SENDER_ID ? '✅ Loaded' : '❌ Missing');
...
try {
  ...
  console.log('\n🎯 app.config.js test:');
  console.log('Firebase API Key from config:', appConfig.default.expo.extra.firebaseApiKey ? '✅ Available' : '❌ Missing');
} catch (error) {
